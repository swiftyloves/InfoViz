...
function drawPie(salaryData, projectList, pieSvg) {
    ...
    //STEP 1.2
    var arc = d3.svg.arc();
        // .outerRadius()//YOUR WORK HERE
        // .innerRadius();//YOUR WORK HERE
    ...
    var tip = d3.tip()
        ...
        .offset([-10, 0])
        .html(function (d, i) {
            return "<strong>" + "YOUR WORK HERE(PROJECT NAME)" + "</strong> <span style='color:red'>" + "YOUR WORK HERE(SALARY OF THIS PROJECT)" + "</span>";//your work here
        });
    ...
    for (var idx in salaryData) {
        ...
        aPieChart.append("text")
            .text("")//your work here
            .attr("x", undefined)//your work here
            .attr("y", undefined)//your work here //set the title on the bottom of the subchart.
